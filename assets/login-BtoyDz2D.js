import"./style-XjoQjjOA.js";function Rt(){return!!JSON.parse(localStorage.getItem("user"))?.accessToken}const En=document.querySelector("#login-item");Rt()&&(En.style.display="none");var nt={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cn=()=>kn().__FIREBASE_DEFAULTS__,Rn=()=>{if(typeof process>"u"||typeof nt>"u")return;const n=nt.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},Pn=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&Dt(n[1]);return e&&JSON.parse(e)},xe=()=>{try{return Cn()||Rn()||Pn()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},On=n=>{var e,t;return(t=(e=xe())===null||e===void 0?void 0:e.emulatorHosts)===null||t===void 0?void 0:t[n]},Lt=()=>{var n;return(n=xe())===null||n===void 0?void 0:n.config},Mt=n=>{var e;return(e=xe())===null||e===void 0?void 0:e[`_${n}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function p(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Dn(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(p())}function Ln(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function Mn(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Un(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function xn(){const n=p();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Bn(){try{return typeof indexedDB=="object"}catch{return!1}}function Fn(){return new Promise((n,e)=>{try{let t=!0;const r="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(r);i.onsuccess=()=>{i.result.close(),t||self.indexedDB.deleteDatabase(r),n(!0)},i.onupgradeneeded=()=>{t=!1},i.onerror=()=>{var s;e(((s=i.error)===null||s===void 0?void 0:s.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S=new Ut("@firebase/app"),pr="@firebase/app-compat",gr="@firebase/analytics-compat",mr="@firebase/analytics",_r="@firebase/app-check-compat",vr="@firebase/app-check",Ir="@firebase/auth",yr="@firebase/auth-compat",br="@firebase/database",wr="@firebase/data-connect",Er="@firebase/database-compat",Tr="@firebase/functions",Sr="@firebase/functions-compat",Ar="@firebase/installations",kr="@firebase/installations-compat",Cr="@firebase/messaging",Rr="@firebase/messaging-compat",Pr="@firebase/performance",Or="@firebase/performance-compat",Nr="@firebase/remote-config",Dr="@firebase/remote-config-compat",Lr="@firebase/storage",Mr="@firebase/storage-compat",Ur="@firebase/firestore",xr="@firebase/vertexai",Br="@firebase/firestore-compat",Fr="firebase",$r="11.0.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Z=$r;function $t(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:Ne,automaticDataCollectionEnabled:!1},e),i=r.name;if(typeof i!="string"||!i)throw N.create("bad-app-name",{appName:String(i)});if(t||(t=Lt()),!t)throw N.create("no-options");const s=le.get(i);if(s){if(ce(t,s.options)&&ce(r,s.config))return s;throw N.create("duplicate-app",{appName:i})}const o=new Yn(i);for(const a of De.values())o.addComponent(a);const c=new Wr(t,r,o);return le.set(i,c),c}function zr(n=Ne){const e=le.get(n);if(!e&&n===Ne&&Lt())return $t();if(!e)throw N.create("no-app",{appName:n});return e}function F(n,e,t){var r;let i=(r=Hr[n])!==null&&r!==void 0?r:n;t&&(i+=`-${t}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const c=[`Unable to register library "${i}" with version "${e}":`];s&&c.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),S.warn(c.join(" "));return}K(new j(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gr="firebase-heartbeat-database",qr=1,J="firebase-heartbeat-store";let Ae=null;function Ht(){return Ae||(Ae=lr(Gr,qr,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(J)}catch(t){console.warn(t)}}}}).catch(n=>{throw N.create("idb-open",{originalErrorMessage:n.message})})),Ae}async function Kr(n){try{const t=(await Ht()).transaction(J),r=await t.objectStore(J).get(Vt(n));return await t.done,r}catch(e){if(e instanceof D)S.warn(e.message);else{const t=N.create("idb-get",{originalErrorMessage:e?.message});S.warn(t.message)}}}async function lt(n,e){try{const r=(await Ht()).transaction(J,"readwrite");await r.objectStore(J).put(e,Vt(n)),await r.done}catch(t){if(t instanceof D)S.warn(t.message);else{const r=N.create("idb-set",{originalErrorMessage:t?.message});S.warn(r.message)}}}function Vt(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ei(n){K(new j("platform-logger",e=>new hr(e),"PRIVATE")),K(new j("heartbeat",e=>new Xr(e),"PRIVATE")),F(Oe,at,n),F(Oe,at,"esm2017"),F("fire-js","")}ei("");function Fe(n,e){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(n);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(n,r[i])&&(t[r[i]]=n[r[i]]);return t}function jt(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const ti=jt,Wt=new X("auth","Firebase",jt());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ue=new Ut("@firebase/auth");function ni(n,...e){ue.logLevel<=h.WARN&&ue.warn(`Auth (${Z}): ${n}`,...e)}function ie(n,...e){ue.logLevel<=h.ERROR&&ue.error(`Auth (${Z}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function di(n,e){return G(n,"POST","/v1/accounts:delete",e)}async function Kt(n,e){return G(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function de(n){var e;const t=n.auth,r=await n.getIdToken(),i=await Y(n,Kt(t,{idToken:r}));u(i?.users.length,t,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const o=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?Jt(s.providerUserInfo):[],c=mi(n.providerData,o),a=n.isAnonymous,l=!(n.email&&s.passwordHash)&&!c?.length,d=a?l:!1,f={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:c,metadata:new Me(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,f)}async function gi(n){const e=z(n);await de(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function mi(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function Jt(n){return n.map(e=>{var{providerId:t}=e,r=Fe(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _i(n,e){const t=await Gt(n,{},async()=>{const r=Q({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:s}=n.config,o=qt(n,i,"/v1/token",`key=${s}`),c=await n._getAdditionalHeaders();return c["Content-Type"]="application/x-www-form-urlencoded",zt.fetch()(o,{method:"POST",headers:c,body:r})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function vi(n,e){return G(n,"POST","/v2/accounts:revokeToken",je(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mt(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(en(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Xt(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(nn(e))return"Blackberry";if(rn(e))return"Webos";if(Qt(e))return"Safari";if((e.includes("chrome/")||Zt(e))&&!e.includes("edge/"))return"Chrome";if(tn(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if(r?.length===2)return r[1]}return"Other"}function Xt(n=p()){return/firefox\//i.test(n)}function Qt(n=p()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Zt(n=p()){return/crios\//i.test(n)}function en(n=p()){return/iemobile/i.test(n)}function tn(n=p()){return/android/i.test(n)}function nn(n=p()){return/blackberry/i.test(n)}function rn(n=p()){return/webos/i.test(n)}function ze(n=p()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Ii(n=p()){var e;return ze(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function yi(){return xn()&&document.documentMode===10}function sn(n=p()){return ze(n)||tn(n)||rn(n)||nn(n)||/windows phone/i.test(n)||en(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function on(n,e=[]){let t;switch(n){case"Browser":t=mt(p());break;case"Worker":t=`${mt(p())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Z}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pi(n,e){const t=Ft(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),s=t.getOptions();if(ce(s,e??{}))return i;I(i,"already-initialized")}return t.initialize({options:e})}function Oi(n,e){const t=e?.persistence||[],r=(Array.isArray(t)?t:[t]).map(T);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e?.popupRedirectResolver)}function Ni(n,e,t){const r=ge(n);u(r._canInitEmulator,r,"emulator-config-failed"),u(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=an(e),{host:o,port:c}=Di(e),a=c===null?"":`:${c}`;r.config.emulator={url:`${s}//${o}${a}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:c,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})}),Li()}function an(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Di(n){const e=an(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:vt(r.substr(s.length+1))}}else{const[s,o]=r.split(":");return{host:s,port:vt(o)}}}function vt(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Li(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cn{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return w("not implemented")}_getIdTokenResponse(e){return w("not implemented")}_linkToIdToken(e,t){return w("not implemented")}_getReauthenticationResolver(e){return w("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bi(n,e,t=!1){if(b(n.app))return Promise.reject(U(n));const r="signIn",i=await ln(n,r,e),s=await W._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}function Fi(n,e,t,r){return z(n).onIdTokenChanged(e,t,r)}function $i(n,e,t){return z(n).beforeAuthStateChanged(e,t)}const fe="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class un{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(fe,"1"),this.storage.removeItem(fe),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pn(){return typeof v().WorkerGlobalScope<"u"&&typeof v().importScripts=="function"}async function qi(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function Ki(){var n;return((n=navigator?.serviceWorker)===null||n===void 0?void 0:n.controller)||null}function Ji(){return pn()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vn(n,e){return e?T(e):(u(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const as="pendingRedirect",oe=new Map;class cs extends In{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=oe.get(this.auth._key());if(!e){try{const r=await ls(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}oe.set(this.auth._key(),e)}return this.bypassAuthState||oe.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function ls(n,e){const t=hs(e),r=ds(n);if(!await r._isAvailable())return!1;const i=await r._get(t)==="true";return await r._remove(t),i}function us(n,e){oe.set(n._key(),e)}function ds(n){return T(n._redirectPersistence)}function hs(n){return se(as,n.config.apiKey,n.name)}async function fs(n,e,t=!1){if(b(n.app))return Promise.reject(U(n));const r=ge(n),i=vn(r,e),o=await new cs(r,i,t).execute();return o&&!t&&(delete o.user._redirectEventId,await r._persistUserIfCurrent(o.user),await r._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ns={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Ds=500,Ls=600,Ms="_blank",Us="http://localhost";class Tt{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function xs(n,e,t,r=Ds,i=Ls){const s=Math.max((window.screen.availHeight-i)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let c="";const a=Object.assign(Object.assign({},Ns),{width:r.toString(),height:i.toString(),top:s,left:o}),l=p().toLowerCase();t&&(c=Zt(l)?Ms:t),Xt(l)&&(e=e||Us,a.scrollbars="yes");const d=Object.entries(a).reduce((g,[y,B])=>`${g}${y}=${B},`,"");if(Ii(l)&&c!=="_self")return Bs(e||"",c),new Tt(null);const f=window.open(e||"",c,d);u(f,n,"popup-blocked");try{f.focus()}catch{}return new Tt(f)}function Bs(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */F(Zs,eo,"app");const to={apiKey:"AIzaSyBrAnnEqJNw1Y9BkHnGNYMInCooEtsAb9w",authDomain:"login-authentication-6c48c.firebaseapp.com",projectId:"login-authentication-6c48c",storageBucket:"login-authentication-6c48c.appspot.com",messagingSenderId:"687996949406",appId:"1:687996949406:web:324418b45c8e52ad703c8f",measurementId:"G-Q1D63HBG95"},no=$t(to);Rt()&&(location.href="./index.html");const ro=new m,io=Xs(no),so=document.querySelector("#login-with-google");so.addEventListener("click",function(){os(io,ro).then(n=>{m.credentialFromResult(n).accessToken;const{displayName:t,email:r,photoURL:i,accessToken:s,uid:o}=n.user;localStorage.setItem("user",JSON.stringify({displayName:t,email:r,photoURL:i,accessToken:s,uid:o})),location.href="/index.html"}).catch(n=>{n.code,n.message,n.customData.email,m.credentialFromError(n)})});
