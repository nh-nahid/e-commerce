...
const createProduct = ( productID, image, title, rating, price, salePrice) => {
    ...
    return/*html*/ ` <div class="product-container">
              <a class="product-link" href="/pages/single.html?id=${+productID}"><div class="product-img"><img src="${image}" alt=""></div></a>
             <a class="product-link" href="/pages/single.html?id=${+productID}"> <div class="product-title">${title}</div></a>
...
const currentPageProducts = productData.slice(productStartNumber, productEndNumber)
  ...
  if(currentPageProducts.length === 0){
    ...
    currentPageProducts.forEach((props) => {
        ...
        const {id, image: image, title: title, rating: rating, price: price, salePrice: salePrice, category: productCategory, country: country} = props;

        const productHTML = createProduct(id, image, title, rating, price, salePrice, country);
